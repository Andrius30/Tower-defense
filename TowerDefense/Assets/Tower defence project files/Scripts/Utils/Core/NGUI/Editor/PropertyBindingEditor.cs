...
public class PropertyBindingEditor : Editor
{
	public override void OnInspectorGUI ()
	{
		...
		UIEditorTools.DrawProperty(serializedObject, "source");
		...
		UIEditorTools.DrawProperty(serializedObject, "target");
		...
		GUILayout.Space(1f);
		UIEditorTools.DrawPaddedProperty(serializedObject, "direction");
		UIEditorTools.DrawPaddedProperty(serializedObject, "update");
		GUILayout.BeginHorizontal();
		UIEditorTools.DrawProperty(" ", serializedObject, "editMode", GUILayout.Width(100f));
